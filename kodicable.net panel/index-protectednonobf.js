...
fetch(`http://localhost:3000/api/getstreamkey`, {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json'
  },
...
function changetitle() {
  ...
  if (newTitle === '') {
    ...
    fetch(`http://localhost:3000/api/changetitle`, {
      method: 'POST',
...
function getMultistreamingPoints(){
  fetch(`http://localhost:3000/api/getMultistreamingPoints`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
    },
...
function saveMultistreamingPoints() {
  ...
  if (isUrlValid(points)) {
    ...
    fetch('http://localhost:3000/api/sendMultistreamingPoints', {
      method: 'POST',
      body: JSON.stringify(data),
      headers: { 'Content-Type': 'application/json' },
    })
